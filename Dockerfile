...
# Use COPY instead of --mount=type=bind for Railway compatibility.
...
RUN --mount=type=tmpfs,id=s/be933eea-e6e5-4df2-ba3a-b39fad861511-/root/.local/share/pnpm/store,target=/root/.local/share/pnpm/store,sharing=locked \
...
ARG OPENCLAW_EXTENSIONS
ARG OPENCLAW_BUNDLED_PLUGIN_DIR
RUN --mount=type=cache,id=s/be933eea-e6e5-4df2-ba3a-b39fad861511-/root/.local/share/pnpm/store,target=/root/.local/share/pnpm/store,sharing=locked \
...
RUN --mount=type=cache,id=s/be933eea-e6e5-4df2-ba3a-b39fad861511-/var/cache/apt,target=/var/cache/apt,sharing=locked \
    --mount=type=cache,id=s/be933eea-e6e5-4df2-ba3a-b39fad861511-/var/lib/apt,target=/var/lib/apt,sharing=locked \
    apt-get update && \
